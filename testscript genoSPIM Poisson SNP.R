...
source("map.genos.R")
source("NimbleModel genoSPIM Poisson SNP.R")
...
#Let's simulate 25% of observed SNPs to be missing
pID <- rep(0.75,n.cov) #loci-level sample by replication amplification probabilities (controls level of missing scores)
...
#                     type = 'GSampler',
#                     control = list(i = i,m=m,n.rep=n.rep.use,
